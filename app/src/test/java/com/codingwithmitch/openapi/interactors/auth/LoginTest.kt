...
import com.codingwithmitch.openapi.datasource.datastore.AppDataStoreServiceManagerFake
...
class LoginTest {
    ...
    private lateinit var dataStore: AppDataStoreServiceManagerFake
    ...
    fun setup() {
        ...
        dataStore = AppDataStoreServiceManagerFake()
